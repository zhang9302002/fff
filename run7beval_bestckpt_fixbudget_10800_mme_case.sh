...
if [ $DO_EVAL -eq 1 ]; then
    ...
    do
        suffix="max${max_frames}_reso${pixel_expr}_10800_mmecase"
        ...
        do
            ...
            python3 eval_any_dataset.py \
                ...
                --flash_memory_dict '{"flash_memory_temporal_length":120,"flash_memory_temporal_method":"kmeans_ordered","flash_memory_temporal_poolsize":2,"flash_memory_spatial_length":60,"flash_memory_spatial_method":"klarge"}' \
